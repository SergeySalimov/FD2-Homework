...
describe('tdd-home.js -> It should remove all values from list a, which are present in list b', function() {
  ...
  // extened test
  it('Test with several repeat', function() {
    expect(arrayDiff([1, 8, 2, 4, 5, 3, 2], [2])).toEqual([1, 8, 4, 5, 3]);
  });
  it('Test with several repeat and more than one element in list b', function() {
    expect(arrayDiff([1, 8, 2, 11, 4, 5, 6, 1, 11, 8, 3, 6, 7, 11], [6, 11, 1])).toEqual([8, 2, 4, 5, 8, 3, 7]);
  });

  it('Test with several repeat and more than one element in list b + some errors', function() {
    expect(arrayDiff([1, 8, 2, 11, 4, 5, 6, 1, 11, 8, 3, 6, 7, 11], [6, 6, 1, 11, 1])).toEqual([8, 2, 4, 5, 8, 3, 7]);
  });
